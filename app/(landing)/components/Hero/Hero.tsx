        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 items-center gap-12'>
          ...
          <div>
            <div className='w-fit py-1.5 px-2 md:px-5 rounded-full shadow-md flex items-center space-x-3 bg-white '>
              <div className='px-3 py-1 md:px-5 md:py-1 rounded-full bg-blue-700 text-base sm:text-sm text-xs text-white'>
                News
              </div>
            ...
            <p className='text-gray-700'>
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aperiam optio aliquid autem, nobis tenetur dolor obcaecati corporis sit totam velit nemo numquam consectetur culpa natus magnam quae nisi aut aliquam.
            </p>
